...
export const GalleryData = createContext();

function App() {
  const [imagesData] = useState([
    {
      id: 1,
    ...
    {
      id: 8,
      className: "eighthImage",
      name: "The Sleeping Gypsy",
      year: 1897,
      description:
        "The Sleeping Gypsy is a painting by French artist Henri Rousseau. It depicts a Roma woman sleeping peacefully in a desert, surrounded by a lion and a starry sky. Rousseau painted it using his characteristic style of naive art, which portrays a sense of wonder and simplicity.",
    ...
    },
    {
      ...
      year: 1489,
      description:
        "The Lady with an Ermine is a portrait painting attributed to Leonardo da Vinci. It depicts Cecilia Gallerani, a mistress of Duke Ludovico Sforza. The painting is renowned for its depiction of the ermine, which symbolizes purity and moderation.",
    ...
    },
    {
      ...
      year: 1888,
      description:
        "The Night Café is an oil painting by Vincent van Gogh depicting the interior of a café in Arles. The painting is known for its vivid colors and dramatic use of light and shadow, which create an intense atmosphere.",
    ...
    {
      id: 11,
      className: "eleventhImage",
      name: "The Basket of Apples",
      year: 1893,
      description:
        "The Basket of Apples is a still life painting by Paul Cézanne. It is noted for its complex perspective and distortion of objects to create multiple viewpoints, which influenced future art movements like Cubism.",
    ...
    {
      id: 12,
      className: "twelfthImage",
      name: "The Boy in the Red Vest",
      year: 1889,
      description:
        "The Boy in the Red Vest is a portrait by Paul Cézanne of a young Italian boy. The painting is notable for its exploration of color and composition, presenting the boy in a melancholic and contemplative pose.",
    ...
    {
      id: 13,
      className: "thirteenthImage",
      name: "Arnolfini Portrait",
      year: 1434,
      description:
        "The Arnolfini Portrait is a painting by Jan van Eyck. It is celebrated for its detailed realism and complex symbolism, including the use of a convex mirror to expand the spatial depth of the composition.",
    ...
    {
      id: 14,
      className: "fourteenthImage",
      name: "Mona Lisa",
      year: 1503,
      description:
        "The Mona Lisa, painted by Leonardo da Vinci, is one of the most famous portraits in the world. It is renowned for its subject's enigmatic expression and the painter's innovative use of sfumato.",
    ...
    {
      id: 15,
      className: "fifteenthImage",
      name: "The Swing",
      year: 1767,
      description:
        "The Swing is a painting by Jean-Honoré Fragonard depicting a woman on a swing, with a hidden lover watching her. The painting is celebrated for its playful and flirtatious theme, as well as its rococo style.",
  ...
  return (
    <GalleryData.Provider
      value={{ imagesData, isSlideshowActive, UpdateIsSlideshowActive }}
    >
      <BrowserRouter>
        <Routes>
